...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-2B0A1OUC\\HOANGLONG;Database=FUNewsManagementSystem;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A2BFA92B71E");
        ...
        {
            entity.HasKey(e => e.NewsArticleId).HasName("PK__NewsArti__4CD0926CB6BB3285");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.NewsArticles)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("NewsArticleId", "TagId").HasName("PK__NewsTag__9A875DC87A66B411");
                        j.ToTable("NewsTag");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586F9FFD815");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.AccountEmail, "UQ__SystemAc__FC770D33676CD467").IsUnique();
        ...
        {
            entity.HasKey(e => e.TagId).HasName("PK__Tag__657CFA4C6C45646E");

            entity.ToTable("Tag");

            entity.HasIndex(e => e.TagName, "UQ__Tag__BDE0FD1D12F63A96").IsUnique();
